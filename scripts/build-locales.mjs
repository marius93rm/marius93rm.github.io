...
const localeConfigs = {
  it: {
    ...
    translations: [
      ...
      ["Thanks for reaching out. I’ll get back to you soon.", "Grazie per avermi scritto. Ti risponderò il prima possibile."],
      ["Your message couldn’t be sent. Please try again.", "Non è stato possibile inviare il messaggio. Riprova."],
      ["Please enter your name.", "Inserisci il tuo nome."],
      ["Enter a valid email address.", "Inserisci un indirizzo email valido."],
      ["Please check this field.", "Controlla questo campo."],
      ["Add a short message about your goal.", "Aggiungi un breve messaggio sul tuo obiettivo."],
  ...
  ro: {
    ...
    translations: [
      ...
      ["Thanks for reaching out. I’ll get back to you soon.", "Mulțumesc pentru mesaj. Îți voi răspunde cât de curând."],
      ["Your message couldn’t be sent. Please try again.", "Mesajul nu a putut fi trimis. Încearcă din nou."],
      ["Please enter your name.", "Introdu numele tău."],
      ["Enter a valid email address.", "Introdu o adresă de email validă."],
      ["Please check this field.", "Verifică acest câmp."],
      ["Add a short message about your goal.", "Scrie câteva rânduri despre obiectivul tău."],
